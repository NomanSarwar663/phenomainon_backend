...
async function addListing(req, res) {
    try {
        ...
        const response = await listingService.addListing(req.body, req.user._id);
...
async function getListingByLandlord(req, res) {
    try {
        ...
        const response = await listingService.getListingByLandlord(req.user._id);
...
async function updateListing(req, res) {
    try {
        const { id } = req.params;
        const response = await listingService.updateListing(req.body, id);
